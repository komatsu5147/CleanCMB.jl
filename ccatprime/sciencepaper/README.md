...
This package provides the softwares and data files to reproduce the results in Section 6 of the [science forecast paper](https://arxiv.org/abs/2107.10364) for CCAT-prime's Prime-Cam on the [Fred Young Submillimeter Telescope (FYST)](https://www.ccatobservatory.org/index.cfm).
